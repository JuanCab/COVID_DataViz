...
def BuildJHVarDict():
    ...
    var_dict = {
        'Confirmed': {'descript': 'Total Confirmed COVID Infections', 'valdescript': 'COVID Infections', 'stateonly': False},
        'ConfirmedRate': {'descript': 'Total Confirmed COVID Infections (per 100,000 persons)', 'valdescript': 'COVID Infections (per 100,000)', 'stateonly': False},
        'dConfirmed': {'descript': 'New COVID Infections (#/day)', 'valdescript': 'New COVID Infections/Day', 'stateonly': False},
        'dConfirmedRate': {'descript': 'New COVID Infections (#/day per 100,000 people)', 'valdescript': 'New COVID Infections/Day (per 100,000)', 'stateonly': False},
        'd2Confirmed': {'descript': 'Change in New COVID Infections', 'valdescript': 'New COVID Infections/Day vs. Previous Day', 'stateonly': False},
        'd2ConfirmedRate': {'descript': 'Change in New COVID Infections (per 100,000 people)', 'valdescript': 'New COVID Infections/Day vs. Previous Day (per 100,000)', 'stateonly': False},
        'Deaths': {'descript': 'Total Confirmed and Probable COVID Deaths', 'valdescript': 'COVID Deaths', 'stateonly': False},
        'DeathRate': {'descript': 'Total Confirmed COVID Deaths (per 100,000 people)', 'valdescript': 'COVID Deaths (per 100,000)', 'stateonly': False},
        'dDeaths': {'descript': 'New COVID Deaths (#/day)', 'valdescript': 'New COVID Deaths/Day', 'stateonly': False},
        'dDeathsRate': {'descript': 'New COVID Deaths (#/day per 100,000 people)', 'valdescript': 'New COVID Deaths/Day (per 100,000)', 'stateonly': False},
        'd2Deaths': {'descript': 'Change in New COVID Deaths', 'valdescript': 'New COVID Deaths/Day vs. Previous Day', 'stateonly': False},
        'd2DeathsRate': {'descript': 'Change in New COVID Deaths (per 100,000 people)', 'valdescript': 'New COVID Deaths/Day vs. Previous Day (per 100,000)', 'stateonly': False},
        'Recovered': {'descript': 'Total Confirmed and Probable COVID Recoveries', 'valdescript': 'COVID Recoveries', 'stateonly': True},
        'Active': {'descript': 'Tota; Confirmed and Probable Active COVID Cases', 'valdescript': 'Active COVID Cases', 'stateonly': True},
        'People_Tested': {'descript': 'Total People tested for COVID', 'valdescript': 'People tested for COVID', 'stateonly': True},
        'Testing_Rate': {'descript': 'Total Tested for COVID (per 100,000 persons)', 'valdescript': 'People tested for COVID (per 100,000)', 'stateonly': True},
        'Mortality_Rate': {'descript': 'Mortality Rate', 'valdescript': '% Deaths per Infection', 'stateonly': True},
        'People_Hospitalized': {'descript': 'Total People Hospitalized for COVID', 'valdescript': 'People Hospitalized', 'stateonly': True},
        'Hospitalization_Rate': {'descript': 'Hospitalization Rate (per 100,000 persons)', 'valdescript': 'People Hospitalized (per 100,000)', 'stateonly': True},
        }
    return var_dict
