...
#
# ## WARNING: This is the OLD version of the notebook, left here for learning purposes.  Version 2, in which most of the code for retrieving remote data has been moved to an external python library file, is the one I will maintain in the future - Juan
#
